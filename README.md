...
```
npm create cloudflare@latest -- --template=cloudflare/templates/royal-cherry-4db7
```

A live public deployment of this template is available at [https://royal-cherry-4db7.templates.workers.dev](https://royal-cherry-4db7.templates.workers.dev)
